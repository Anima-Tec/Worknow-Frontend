...
import {
  FaBuilding, FaGlobe, FaUserTie, FaTools, FaRegClock,
  FaMapMarkerAlt, FaMoneyBillWave, FaFileAlt, FaCalendarAlt
} from "react-icons/fa";
      ...
      <div className="apply-modal">
        ...
        <div className="apply-info-box">
          <div className="apply-info-item">
            ...
            <strong>Empresa:</strong> {data.company?.nombreEmpresa || "No especificada"}
          </div>
